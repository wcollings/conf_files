...
call plug#end()
nnore gt :call ShowDocumentation()<CR>
...
""C
au FileType c inore `<Space> <Esc>/<++><Enter>"_4cl
au FileType c nnore co I//<Esc>
au FileType c inore `i #include <><++><Esc>4hi
...
au FileType julia nnore co I#<Esc>
au FileType julia nnore cu ^x
" WSL yank support
